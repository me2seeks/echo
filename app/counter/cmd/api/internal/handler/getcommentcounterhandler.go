...
// get comment counter
func getCommentCounterHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := logic.NewGetCommentCounterLogic(r.Context(), svcCtx)
		resp, err := l.GetCommentCounter(&req)
